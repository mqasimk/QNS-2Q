...
def plot_all_spectrums(axs, w_plot, wk, specs1, specs2, params):
    ...
    plot_complex_spectrum(axs[1, 0], w_plot, wk, s1['S12'], s2['S12'], S_1_2(w_plot), r'$S_{1,2}(\omega)$', r'$\omega\tau$', r'$S^+_{a,b}(\omega)\,\tau$', [r'Re[$\hat{S}_{1,2}(\omega_k)$]', r'Re[$\hat{S}_{1,2,mit}(\omega_k)$]', r'Re[$S_{1,2}(\omega)$]', r'Im[$\hat{S}_{1,2}(\omega_k)$]', r'Im[$\hat{S}_{1,2,mit}(\omega_k)$]', r'Im[$S_{1,2}(\omega)$]'])
    plot_complex_spectrum(axs[1, 1], w_plot, wk, s1['S112'], s2['S112'], S_1_12(w_plot), r'$S_{1,12}(\omega)$', r'$\omega\tau$', '', [r'Re[$\hat{S}_{1,12}(\omega_k)$]', r'Re[$\hat{S}_{1,12,mit}(\omega_k)$]', r'Re[$S_{1,12}(\omega)$]', r'Im[$\hat{S}_{1,12}(\omega_k)$]', r'Im[$\hat{S}_{1,12,mit}(\omega_k)$]', r'Im[$S_{1,12}(\omega)$]'])
    plot_complex_spectrum(axs[1, 2], w_plot, wk, s1['S212'], s2['S212'], S_2_12(w_plot), r'$S_{2,12}(\omega)$', r'$\omega\tau$', '', [r'Re[$\hat{S}_{2,12}(\omega_k)$]', r'Re[$\hat{S}_{2,12,mit}(\omega_k)$]', r'Re[$S_{2,12}(\omega)$]', r'Im[$\hat{S}_{2,12}(\omega_k)$]', r'Im[$\hat{S}_{2,12,mit}(\omega_k)$]', r'Im[$S_{2,12}(\omega)$]'])
