...
pulse_2_1 = ['CDD3', 'CDD1']
C_12_12_MT_1 = make_C_12_12_MT(solver_prop, pulse_2_1, noise_mats, t_vec, c_times, n_shots=n_shots, M=M, t_b=t_b,
                               a_m=a_m, delta=delta, state='pp', a_sp=a_sp, c=c)
print("Experiment 2.1 complete")


# Step 2.2) CDD3 on qubit 1 and CP on qubit 2 and evaluate $$C_{12,12}^{2,k}(MT)$$
pulse_2_2 = ['CDD3', 'CPMG']
C_12_12_MT_2 = make_C_12_12_MT(solver_prop, pulse_2_2, noise_mats, t_vec, c_times, n_shots=n_shots, M=M, t_b=t_b,
                               a_m=a_m, delta=delta, state='pp', a_sp=a_sp, c=c)
...
pulse_3_3 = ['CDD1', 'CDD1']
C_12_0_MT_4 = make_C_12_0_MT(solver_prop, pulse_3_3, noise_mats, t_vec, c_times, n_shots=n_shots, M=M, t_b=t_b, a_m=a_m,
                             delta=delta, state='pp', a_sp=a_sp, c=c)
